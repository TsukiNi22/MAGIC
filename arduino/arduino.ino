...
#define DEBUG false // Used to print the debug initialisation message
...
void setup() {
    ...
    if (DEBUG) {Serial.print("[Start Void Setup]\n");}
    ...
    if (DEBUG) {Serial.println("Digital pins information:");}
    ...
    if (DEBUG) {Serial.println("Analog pins information:");}
    ...
    if (DEBUG) {Serial.print("[End Void Setup]\n");}
}
